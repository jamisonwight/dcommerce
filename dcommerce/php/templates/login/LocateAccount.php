    ...
    <div class="cell medium-4 medium-offset-4 ecp-component ecp_LocateAccount">
        ...
        <form class="ecp-form">
            <div class="ecp-form-fieldset">
                <input class="sign-in_email" type="text" name="username" placeholder="{message:LocateAccount/EmailInput}"  autocomplete="off">
            </div>
        ...
        <ul class="ecp-item-list">
            ...
            <li><a href="#" class="ecp-option" data-ecp-action="signup"><h2 class="create_account">{message:LocateAccount/SignupLink}</h2></a></li>
        </ul>
    </div>
</div>